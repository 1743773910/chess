...
public class GameScrren extends JFrame{
    ...
    public void update(@NotNull JList list, @NotNull Message msg) throws IOException, ClassNotFoundException {
        DataModel.add(msg.getArr());
        list.updateUI();
    }
    public void fighted(@NotNull Message msg) throws Exception {
